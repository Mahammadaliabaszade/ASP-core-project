...
namespace FinalProjectasp.Migrations
{
    ...
    [Migration("20210309132504_Createusertables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinalProjectasp.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("FinalProjectasp.Models.EventDetail", b =>
                {
                    b.HasOne("FinalProjectasp.Models.Event", "Event")
                        .WithOne("EventDetail")
                        .HasForeignKey("FinalProjectasp.Models.EventDetail", "EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FinalProjectasp.Models.Speaker", b =>
                {
                    b.HasOne("FinalProjectasp.Models.EventDetail", "EventDetail")
                        .WithOne("Speaker")
                        .HasForeignKey("FinalProjectasp.Models.Speaker", "EventDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FinalProjectasp.Models.AppUser", null)
                        .WithMany()
